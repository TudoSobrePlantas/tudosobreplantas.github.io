...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; Tudo Sobre Plantas &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Ir para Tudo Sobre Plantas</a>		</p>
			</div>
...
/* <![CDATA[ */
var _wpUtilSettings = {"ajax":{"url":"\/site-plantas\/wp-admin\/admin-ajax.php"}};
/* ]]> */
</script>
<script type="text/javascript" src="/wp-includes/js/wp-util.min.js?ver=5.8.2" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"aaf8c8fd7f"};
/* ]]> */
</script>
